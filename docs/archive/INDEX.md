...
These documents remain for history. **Do not extend them.** For normative architecture use:

- [`docs/spec/NOEON_CANONICAL_ARCHITECTURE_v1.0.md`](../spec/NOEON_CANONICAL_ARCHITECTURE_v1.0.md)
- [`docs/adr/ADR-003-canonical-architecture-and-dual-ir.md`](../adr/ADR-003-canonical-architecture-and-dual-ir.md)
