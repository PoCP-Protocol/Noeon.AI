...
const SUITES = {
  ...
  product: [
    ...
    'stdlib-http.test.js',
    'stdlib-fs.test.js',
    'stdlib-github.test.js',
    'stdlib-web.test.js',
    'general-canonical-mode.test.js',
    'general-canonical-execution.test.js',
    'canonical-act-runner.test.js',
    'general-canonical-hybrid.test.js',
    'compile-presentation.test.js',
    'cli-compile-canonical.test.js',
    'cli-run-trace.test.js',
    'architecture-view.test.js',
    'doctor-canonical.test.js',
    'lsp-stdlib-hover.test.js',
    'playground-examples.test.js',
